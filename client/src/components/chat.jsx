...
const Chat = () => {
  ...
  const addRoom = () => {
    if (room !== "" && RoomName !== "") {
      updateActiveChatRooms((prevRooms) => [
        ...prevRooms,
        { title: RoomName, to: room },
      ]);
      updateRoom("");
      updateRoomName("");
    } else {
  ...
  const sendMessage = () => {
    if (message.trim() && currentRoom) {
      socket.emit("client_message_room", {
  ...
  const ConditionalRender = (s) => {
    if (s) {
      return (
        <main id="chat-main">
          <div className="Room-change-container-mobile">
            <div className="Room-change-input-container">
                <input
                type="text"
                className="input"
                placeholder="Name"
                ...
                onKeyDown={(event) => event.key === "Enter" && addRoom()}
                />
                <button className="SubmitBtn" onClick={addRoom}>
                Add
                </button>
            </div>
          </div>
          ...
          <div className="Chat-main-container">
            <div className="Open-chats">
              <div className="hidden-over-mobile mobile-add-container">
                <FontAwesomeIcon
                  size="2x"
                  icon={faXmark}
                  style={{ color: "#767f88" }}
              ...
              <div className="Room-change-container mobile-hidden">
                <input
                  type="text"
                  className="input"
                  placeholder="Name"
              ...
              <div className="Chats-container">
                {activeChatRooms.map((e, index) => (
                  <div
                    key={index}
                    className="ChatElement-container"
                    onClick={() => {
